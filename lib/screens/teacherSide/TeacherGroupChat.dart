...
class TeacherGroupChatController extends GetxController {
  ...
  TeacherGroupChatController(this.groupChat, this.teacher, this.school);
  ...
  Future<void> markAsRead() async {
    await Database_Service.markGroupChatMessagesAsRead(groupChat.chatId, teacher.empID, 'teacher');
  }
  ...
  bool isMe(String senderId, String senderType) {
    return senderId == teacher.empID && senderType == 'teacher';
  }
...
class TeacherGroupChatScreen extends StatelessWidget {
  TeacherGroupChatScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    try {
      ...
      final TeacherGroupChatController controller = Get.put(TeacherGroupChatController(groupChat, teacher, school));
    ...
    return Scaffold(
      ...
      print('Error in TeacherGroupChatScreen: $e');
      return Scaffold(
        appBar: AppBar(title: Text('Error')),
        body: Center(
          child: Column(
