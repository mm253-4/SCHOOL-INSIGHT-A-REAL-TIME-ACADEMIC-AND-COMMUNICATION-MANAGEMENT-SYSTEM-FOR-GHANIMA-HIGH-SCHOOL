...
class ChangePasswordController extends GetxController {
  ...
  ChangePasswordController(this.teacher, this.school);
  ...
  Future<void> changePassword() async {
    ...
    final success = await Auth_Service.changeTeacherPassword(
      school.schoolId,
      teacher.empID,
...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ChangePasswordController controller = Get.put(ChangePasswordController(teacher, school));
