...
class ParentChatController extends GetxController {
  ...
  ParentChatController(this.chat, this.student, this.school);
  ...
  Future<void> markAsRead() async {
    await Database_Service.markMessagesAsRead(chat.chatId, 'parent');
  }
...
class ParentChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    try {
      ...
      final ParentChatController controller = Get.put(ParentChatController(chat, student, school));
    ...
    return Scaffold(
      ...
      print('Error in ParentChatScreen: $e');
      return Scaffold(
        appBar: AppBar(title: Text('Error')),
        body: Center(
          child: Column(
