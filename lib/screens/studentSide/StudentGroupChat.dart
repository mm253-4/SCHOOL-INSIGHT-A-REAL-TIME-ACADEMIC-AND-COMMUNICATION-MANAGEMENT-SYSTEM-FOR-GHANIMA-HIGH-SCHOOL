...
class StudentGroupChatController extends GetxController {
  ...
  StudentGroupChatController(this.groupChat, this.student, this.school);
  ...
  Future<void> markAsRead() async {
    await Database_Service.markGroupChatMessagesAsRead(groupChat.chatId, student.studentID, 'student');
  }
  ...
  bool isMe(String senderId, String senderType) {
    return senderId == student.studentID && senderType == 'student';
  }
...
class StudentGroupChatScreen extends StatelessWidget {
  StudentGroupChatScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    try {
      ...
      final StudentGroupChatController controller = Get.put(StudentGroupChatController(groupChat, student, school));
    ...
    return Scaffold(
                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isMe ? AppColors.appOrange : Colors.white,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8),
                IconButton(
                  icon: Icon(Icons.send, color: AppColors.appOrange),
      ...
      print('Error in StudentGroupChatScreen: $e');
      return Scaffold(
        appBar: AppBar(title: Text('Error')),
        body: Center(
          child: Column(
