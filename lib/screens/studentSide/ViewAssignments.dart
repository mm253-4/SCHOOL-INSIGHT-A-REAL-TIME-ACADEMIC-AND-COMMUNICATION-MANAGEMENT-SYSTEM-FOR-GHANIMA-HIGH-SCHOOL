...
class ViewAssignmentsController extends GetxController {
  ...
  ViewAssignmentsController(this.student, this.schoolId);
  ...
  Future<void> loadAssignments() async {
    try {
      ...
      final assignmentsList = await Database_Service.fetchStudentAssignments(
        schoolId,
...
class ViewAssignmentsScreen extends StatelessWidget {
  ViewAssignmentsScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final ViewAssignmentsController controller = Get.put(ViewAssignmentsController(student, schoolId));
  ...
  void _showAssignmentDetails(BuildContext context, Assignment assignment, ViewAssignmentsController controller) {
    final isOverdue = controller.isOverdue(assignment.dueDate!);
                ...
                if (submission == null)
                  ElevatedButton.icon(
                    onPressed: () {
                      ...
                      )?.then((_) => controller.refreshSubmission(assignment.id!));
                    },
