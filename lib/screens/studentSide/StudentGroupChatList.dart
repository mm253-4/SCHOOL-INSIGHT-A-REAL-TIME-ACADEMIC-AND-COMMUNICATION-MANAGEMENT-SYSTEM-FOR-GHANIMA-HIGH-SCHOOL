...
class StudentGroupChatListController extends GetxController {
  ...
  StudentGroupChatListController(this.student, this.school);
  ...
  Future<void> loadGroupChats() async {
    try {
      final chatList = await Database_Service.getStudentGroupChats(
        school.schoolId,
        student.studentID,
      );
...
class StudentGroupChatListScreen extends StatelessWidget {
  StudentGroupChatListScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final StudentGroupChatListController controller = Get.put(StudentGroupChatListController(student, school));
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  'Teachers will create group chats for your classes',
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: ListTile(
                ...
                onTap: () {
                  Get.toNamed('/StudentGroupChat', arguments: [groupChat, student, school]);
                },
              ),
            );
          },
