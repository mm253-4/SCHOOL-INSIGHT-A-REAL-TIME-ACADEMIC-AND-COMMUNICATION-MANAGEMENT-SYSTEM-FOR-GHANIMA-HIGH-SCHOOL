                ...
                if (controller.isLoading.value) {
                  ...
                  return SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: controller.teachers.asMap().entries.map((entry) {
                        int index = entry.key;
                        ...
                        return DataRow(
                          ...
                          cells: [
                            DataCell(
                              Text(
                                teacher.empID,
                                style: Font_Styles.dataTableRows(context, MediaQuery.of(context).size.width * 0.035).copyWith(
                                  color: Colors.black,
                                ),
                              ),
                            ),
                                        ...
                                        children: teacher.subjects.entries.map((entry) {
                                          return Tooltip(
                                            ...
                                            child: Text(
                                              ...
                                              style: Font_Styles.dataTableRows(context, MediaQuery.of(context).size.width * 0.03).copyWith(
                                                color: Colors.black,
                                              ),
