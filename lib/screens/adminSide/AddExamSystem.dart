                  ...
                  child: AppBar(
                    ...
                    actions: <Widget>[
                      ...
                      TextButton(
                        onPressed: () async {
                          try {
                            // Validate that exam structure is not empty
                            if (controller.examStructure.isEmpty) {
                              Get.snackbar(
                                'Error',
                                'Please add at least one exam type (e.g., CA, Mid, Final, Mock)',
                            ...
                            // Validate that classes and subjects exist
                            if (controller.classes == null || controller.classes!.isEmpty) {
                              Get.snackbar(
                                'Error',
                                'Classes information is missing',
                                backgroundColor: Colors.red,
                                colorText: Colors.white,
                              );
                              return;
                            ...
                            if (controller.subjects == null || controller.subjects!.isEmpty) {
                              Get.snackbar(
                                'Error',
                                'Subjects information is missing',
                                backgroundColor: Colors.red,
                                colorText: Colors.white,
                              );
                              return;
                            ...
                            // Navigate to AddWeightage screen
                            final result = await Get.toNamed('/AddWeightage',
                                arguments: {
                                  'className': className,
                                  'classes': controller.classes,
                                  'subjects': controller.subjects,
                                  'examStructure': controller.examStructure.toList(),
                                  'schoolId': controller.school.schoolId.value,
                                });
                            
                            // Debug: Check if navigation was successful
                            print('Navigation result: $result');
                            if (result == null) {
                              print('Warning: Navigation returned null');
                            }
                          } catch (e) {
                            print('Error navigating to AddWeightage: $e');
                            Get.snackbar(
                              'Error',
                              'Failed to proceed. Please check your input: ${e.toString()}',
                              backgroundColor: Colors.red,
                              colorText: Colors.white,
                            );
                          }
