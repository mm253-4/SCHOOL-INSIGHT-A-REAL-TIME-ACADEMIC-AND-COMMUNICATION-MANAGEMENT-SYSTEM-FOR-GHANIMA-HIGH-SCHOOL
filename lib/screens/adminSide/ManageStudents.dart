                ...
                Padding(
                  ...
                  child: Obx(() {
                    return DropdownButtonFormField<String>(
                      initialValue: studentController.selectedClass.value,
                  ...
                  if (studentController.isLoading.value) {
                    ...
                    return SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        rows: studentController.studentsList.asMap().entries
                            .map(
                              (entry) {
                                int index = entry.key;
        ...
        children: [
          ...
          Padding(
            ...
            child: DropdownButtonFormField<String>(
              initialValue: ['paid', 'unpaid'].contains(widget.student.feeStatus)
